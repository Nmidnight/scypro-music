        ...
        <div className={styles.playerBlock}>
          <div className={styles.player}>
            <div className={styles.controls}>
              ...
              <div className={cn(styles.btnPlay, "btn")}>
              ...
              <div className={cn(styles.btnRepeat, styles.iconButton)}>
                <svg className={styles.btnRepeatSvg}>
                  <use xlinkHref="/img/icon/sprite.svg#icon-repeat"></use>
                </svg>
              </div>
              <div className={cn(styles.btnShuffle, styles.iconButton)}>
            ...
            <div className={styles.trackPlay}>
              ...
              <div className={styles.trackPlayActions}>
                <div className={styles.iconButton}>
                  <svg className={styles.likeSvg}>
                    <use xlinkHref="/img/icon/sprite.svg#icon-like"></use>
                  </svg>
                </div>
                <div className={cn(styles.iconButton, styles.dislikeSpaced)}>
          ...
          <div className={styles.volumeBlock}>
            <div className={styles.volumeContent}>
              ...
              <div className={cn(styles.volumeProgress, "btn")}>
                <input
                  className={cn(styles.volumeProgressLine, "btn")}
                  type="range"
                  name="range"
                />
              </div>
